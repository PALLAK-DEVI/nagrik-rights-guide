...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About NyayaSetu — civic and legal information, made usable" },
      {
        name: "description",
        content:
          "Why NyayaSetu exists, how its source-backed AI works, and the privacy, terms and disclaimer that govern its use.",
      },
      { property: "og:title", content: "About NyayaSetu" },
      {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container-page max-w-3xl py-14">
        <h1 className="text-3xl font-semibold sm:text-4xl">About NyayaSetu</h1>
        <p className="mt-4 text-muted-foreground">
          ...
          do next. NyayaSetu exists to close that gap.
        </p>

        <section className="mt-10 space-y-3">
          <h2 className="text-xl font-semibold">How it works</h2>
          <p className="text-muted-foreground">
            NyayaSetu is built as a retrieval-augmented system, not a chatbot. A described problem is
        ...
        <section id="terms" className="mt-10 scroll-mt-24 space-y-3">
          ...
          <p className="text-muted-foreground">
            NyayaSetu is provided as an informational tool. You are responsible for verifying any
